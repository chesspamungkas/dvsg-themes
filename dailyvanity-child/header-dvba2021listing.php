...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri()?>/microsite/DVBA2021Listing/css/DVBA2021Listing.css?v=<?php echo current_time( 'timestamp' ); ?>">

<!--script src="//use.fontawesome.com/554c38fe95.js"></script-->
<!--script src="https://use.fontawesome.com/97755550d3.js"></script-->
<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/js/all.min.js" integrity="sha512-UwcC/iaz5ziHX7V6LjSKaXgCuRRqbTp1QHpbOJ4l1nw2/boCfZ2KlFIqBUA/uRVF0onbREnY9do8rM/uT/ilqw==" crossorigin="anonymous"></script>
<!-- head:js -->

<!--script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/angular/angular.js"></script>
<script src="//ajax.googleapis.com/ajax/libs/angularjs/1.2.1/angular-sanitize.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/js-cookie/src/js.cookie.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/jquery-textfill/source/jquery.textfill.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/moment/moment.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/slick-carousel/slick/slick.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/angular-ui-tree/dist/angular-ui-tree.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/underscore/underscore.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/angular-bootstrap/ui-bootstrap-tpls.js"></script>

<script src="<?php echo get_stylesheet_directory_uri()?>/bower_components/jQuery.dotdotdot/src/js/jquery.dotdotdot.js"></script-->
...
<script type="text/javascript" src="<?php echo get_stylesheet_directory_uri()?>/microsite/DVBA2021Listing/js/slick-lightbox.js"></script>
...
(function(d, s, id){
    ...
    <div id="et-main-area">
      <?php get_template_part( '/microsite/DVBA2021Listing/headerbar' ); ?>
