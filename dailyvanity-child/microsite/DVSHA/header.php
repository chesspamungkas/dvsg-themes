...
<!--<![endif]-->
  <head>
    ...
    <?php 
      if( isset( $slickCss ) && !empty( $slickCss ) ):
        echo '<link rel="stylesheet" href="' . $slickCss . '" type="text/css">';
      endif;
      if( isset( $slickThemeCss ) && !empty( $slickThemeCss ) ):
        echo '<link rel="stylesheet" href="' . $slickThemeCss . '" type="text/css">';
      endif;

      if( isset( $customCss ) && !empty( $customCss ) ):
        echo '<link rel="stylesheet" href="' . $customCss . '" type="text/css">';
      endif;

      if( isset( $lodashJs ) && !empty( $lodashJs ) ):
        echo '<script type="text/javascript" src="' . $lodashJs . '"></script>';
      endif;

      if( isset( $slickJs ) && !empty( $slickJs ) ):
        echo '<script type="text/javascript" src="' . $slickJs . '"></script>';
      endif;

      if( isset( $customJs ) && !empty( $customJs ) ):
        echo '<script type="text/javascript" src="' . $customJs . '"></script>';
      endif;
    ?>
