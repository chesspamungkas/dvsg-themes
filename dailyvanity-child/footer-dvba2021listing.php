        ...
        <footer id="main-footer" class="container-fluid px-md-5 pb-md-3 pt-md-4 px-3 py-4">
            <div class="row m-0 justify-content-md-between justify-content-center">
                <div class="col-12 col-sm-12 col-md-3 mb-1 mb-md-0 px-0 pt-0 pb-1 pb-md-0" id="copyright-address">
                    <p class="no-margin text-shadow">&copy; DAILY VANITY PTE LTD, 2021<br/>
...
<!--script src="<?php // echo get_stylesheet_directory_uri()?>/js/dvMain.min.js?t=007007007"></script>
<script src="<?php // echo get_stylesheet_directory_uri()?>/js/index.module.js?t=007007007"></script-->
<script src="<?php echo get_stylesheet_directory_uri()?>/microsite/DVBA2021Listing/js/DVBA2021Listing.js?v=<?php echo current_time( 'timestamp' ); ?>"></script>
<?php wp_footer(); ?>
<script>
