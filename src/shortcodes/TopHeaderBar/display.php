      ...
      <div class="col">
        <table id="top-header-table">
          <tr>
            ...
            <td><a href="<?php echo home_url(); ?>"><img src="<?php echo S3_PATH; ?>/wp-content/uploads/svg/beauty-magazine-malaysia-daily-vanity-logo-new.svg" id="logo" alt="<?php echo DV_LOGO_ALT; ?>"></a></td>
            <td>
